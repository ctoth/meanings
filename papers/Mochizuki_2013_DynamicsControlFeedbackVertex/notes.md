...
- **Mochizuki et al. (2010)** — earlier "determining nodes" / FVS-and-dynamics result the present paper builds on.
...
- **Liu, Slotine, Barabási (2011), "Controllability of complex networks"** (Nature) — the structural-controllability / driver-node alternative the paper contrasts itself against.
